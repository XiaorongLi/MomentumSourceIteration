...
The corresponding code is in the file "iteration_xflowfactor_forTerminal_github.py". A separate programm called CTF is used to solve the Navier-Stokes equations for the simplified system. A few functions that process the output text files of CTF are also included in the file "iteration_xflowfactor_forTerminal_github.py".
