...
This repo is a small part of my PhD project in the field of numerical modeling of fluid dynamics and heat transfer. I am going to talk about an algorithm that I have developed for an important task in my PhD work. With a lot surprise, I realized just now that it is indeed a small learning algorithm I have developed! To be frank, when I did this job, I did not really know any details about machine learning.
